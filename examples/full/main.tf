 ...
 *
 * _NB_: Some of the required modules have not yet been ported to TF 0.12. These are commented out in the example.
 */
...
/* Add this when the "cloudposse/efs/aws" module is ported to 0.12
...
/* Add this when the "blinkist/airship-ecs-instance-draining/aws" module is ported to 0.12
